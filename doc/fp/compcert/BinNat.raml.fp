...
(*module Pos =
 struct
  ...
  let recsucc = match succ with(myvariable) ->
match myvariable with
...
match myvariable with
  ...
  letpred = match pred with(myvariable) ->
match myvariable with
  | Coq_xI(p) -> Coq_xO p
...
match myvariable with
  ...
  let recsquare = match square with(myvariable) ->
match myvariable with
...
match myvariable with
  ...
  let recsize = match size with(myvariable) ->
match myvariable with
  | Coq_xI(p0) -> S(size p0)
  | Coq_xO(p0) -> S(size p0)
  | Coq_xH -> Coq_xH
  ...
  let sqrtrem_step fg = match g with(myvariable) ->
  ...
  let recsqrtrem = match sqrtrem with(myvariable) ->
match myvariable with
  | Coq_xI(p0) ->
    (match p0 with
     | Coq_xI(p1) ->
      ...
      (match a with
       | Coq_xI(a') ->
         (match b with
          ...
          | Coq_xH -> (Coq_xH, Pair(a, Coq_xH)))
       | Coq_xO(a0) ->
         (match b with
          | Coq_xI(p) ->
            let(g, p0) = ggcdn n0 a0 b in
            let(aa, bb) = p0 in (g, Pair((Coq_xO aa), bb))
          | Coq_xO(b0) -> let(g, p) = ggcdn n0 a0 b0 in Pair((Coq_xO g), p)
          | Coq_xH -> (Coq_xH, Pair(a, Coq_xH)))
       | Coq_xH -> (Coq_xH, Pair(Coq_xH, b)))
...
match myvariable with
  ...
  let shiftlp = match p with(myvariable) ->
match myvariable with
  | N0 -> p
  ...
  let shiftrp = match p with(myvariable) ->
match myvariable with
  | N0 -> p
...
let iff_reflect = function(x) ->
if (x) then ReflectT else ReflectF
...
(*module N =
 struct
  ...
  let succ_double_n = function(myvariable) ->
match myvariable with
  | N0 -> Npos Coq_xH
  | Npos(p) -> Npos (Coq_xI p)
  ...
  let double_n = function(myvariable) ->
match myvariable with
  | N0 -> N0
  | Npos(p) -> Npos (Coq_xO p)
  ...
  let succ_n = function(myvariable) ->
match myvariable with
  | N0 -> Npos Coq_xH
  | Npos(p) -> Npos (succ p)
...
match myvariable with
  ...
  let succ_pos_n = function(myvariable) ->
match myvariable with
  | N0 -> Coq_xH
  | Npos(p) -> succ p
  ...
  let div2_n = function(myvariable) ->
match myvariable with
  | N0 -> N0
  | Npos(p0) ->
    (match p0 with
  ...
  let even_n = function(myvariable) ->
match myvariable with
  | N0 -> true
  | Npos(p) ->
    (match p with
  ...
  let pow_nn = match n with(myvariable) ->
match myvariable with
  | N0 -> Npos Coq_xH
  | Npos(p0) ->
    (match n with
  ...
  let square_n = function(myvariable) ->
match myvariable with
  | N0 -> N0
  ...
  let log2_n = function(myvariable) ->
match myvariable with
  | N0 -> N0
  | Npos(p0) ->
    (match p0 with
  ...
  let size_n = function(myvariable) ->
match myvariable with
  | N0 -> N0
  | Npos(p) -> Npos (size p)
  ...
  let size_nat_n = function(myvariable) ->
match myvariable with
  | N0 -> O
  | Npos(p) -> size_nat p
  ...
  let rec pos_div_eucl a b =
    ...
    | Coq_xI(a') ->
      ...
      if leb_n b r' then ((succ_double_n q), (sub_n r' b)) else Pair((double_n q), r')
    | Coq_xO(a') ->
      let(q, r) = pos_div_eucl a' b in
      let r' = double_n r in
      if leb_n b r' then ((succ_double_n q), (sub_n r' b)) else Pair((double_n q), r')
    | Coq_xH ->
      (match b with
       ...
       | Npos(p) ->
         (match p with
          | Coq_xH -> Pair((Npos Coq_xH), N0)
          | Coq_xI(p0) -> (N0, (Npos Coq_xH))
          | Coq_xO(p0) -> (N0, (Npos Coq_xH))))
  ...
  (*let sqrtrem_n = function(myvariable) ->
match myvariable with
  | N0 -> Pair(N0, N0)
  | Npos(p) ->
  ...
  let sqrt_n = function(myvariable) ->
match myvariable with
  | N0 -> N0
  | Npos(p) -> Npos (sqrt p)*)
  ...
  let shiftr_na = match a with(myvariable) ->
match myvariable with
  | N0 -> a
  ...
  let testbit_nat_n = function(myvariable) ->
match myvariable with
  | N0 -> (fun(x) -> false)
  ...
  let to_nat_n = function(myvariable) ->
match myvariable with
  | N0 -> O
  | Npos(p) -> to_nat p
  ...
  let of_nat_n = function(myvariable) ->
match myvariable with
  | O -> N0
  ...
  letdiscr = match discr with(myvariable) ->
match myvariable with
  | N0 -> None
  | Npos(p) -> Some p
  ...
  let binary_rect f0 f2 fS2 n =
    ...
    (match n with
     | N0 -> f0
     | Npos(p) ->
       let recf = match f with(myvariable) ->
match myvariable with
  ...
  let b2n myvariable =
if (myvariable = true) then Npos Coq_xH else N0
